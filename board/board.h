...
#define SERVO_GPIO_CTRL HPM_GPIO1
#else
#define SERVO_GPIO_CTRL HPM_GPIO0
#endif

#define BOARD_RS485_BAUDRATE            7500000UL
#define BOARD_RS485_UART_BASE           HPM_UART0

#define BOARD_RS485_UART_CLOCK_NAME     clock_uart0
#define BOARD_RS485_UART_IRQ            IRQn_UART0
#define BOARD_RS485_UART_TX_DMA_REQ     HPM_DMA_SRC_UART0_TX
#define BOARD_RS485_UART_RX_DMA_REQ     HPM_DMA_SRC_UART0_RX

#define BOARD_RS485_UART_DMA_CONTROLLER        BOARD_APP_HDMA
#define BOARD_RS485_UART_DMAMUX_CONTROLLER     BOARD_APP_DMAMUX
#define BOARD_RS485_UART_TX_DMA_CHN            (0U)
#define BOARD_RS485_UART_RX_DMA_CHN            (1U)
#define BOARD_RS485_UART_TX_DMAMUX_CHN         DMA_SOC_CHN_TO_DMAMUX_CHN(BOARD_RS485_UART_DMA_CONTROLLER, BOARD_RS485_UART_TX_DMA_CHN)
#define BOARD_RS485_UART_RX_DMAMUX_CHN         DMA_SOC_CHN_TO_DMAMUX_CHN(BOARD_RS485_UART_DMA_CONTROLLER, BOARD_RS485_UART_RX_DMA_CHN)
#define BOARD_RS485_UART_DMA_IRQ               BOARD_APP_HDMA_IRQ

#define BOARD_RS485_DIR_GPIO_CTRL  SERVO_GPIO_CTRL
#define BOARD_RS485_DIR_GPIO_INDEX GPIO_DO_GPIOF
#define BOARD_RS485_DIR_GPIO_PIN   (15U)
...
#endif
#endif
#define BOARD_CONSOLE_UART_BAUDRATE (1000000UL)
#endif
#endif
...
#define BOARD_BLDC_ADC_UDC_BASE  HPM_ADC1
#define BOARD_BLDC_ADC_TEMP_BASE HPM_ADC0
#define BOARD_BLDC_ADC_TRIG_FLAG adc16_event_trig_complete

#define BOARD_BLDC_ADC_CH_U                   (11U)  // PF02
#define BOARD_BLDC_ADC_CH_V                   (13U)  // PF03
#define BOARD_BLDC_ADC_CH_W                   (4U)   // PF13
#define BOARD_BLDC_ADC_CH_UDC                 (2U)   // PF05
#define BOARD_BLDC_ADC_CH_TEMP                (14U)  // PF06
...
#define BOARD_BLDC_ADC_UDC_BASE  HPM_ADC3  // ADC2/3
#define BOARD_BLDC_ADC_TEMP_BASE HPM_ADC0
#define BOARD_BLDC_ADC_TRIG_FLAG adc16_event_trig_complete

#define BOARD_BLDC_ADC_CH_U                   (14U)  // PF06
#define BOARD_BLDC_ADC_CH_V                   (10U)  // PF08
#define BOARD_BLDC_ADC_CH_W                   (11U)  // PF19
#define BOARD_BLDC_ADC_CH_UDC                 (7U)   // PF31
#define BOARD_BLDC_ADC_CH_TEMP                (1U)  // PF10
#define BOARD_BLDC_ADC_IRQn                   IRQn_ADC0
#define BOARD_BLDC_ADC_PMT_DMA_SIZE_IN_4BYTES (ADC_SOC_PMT_MAX_DMA_BUFF_LEN_IN_4BYTES)
#define BOARD_BLDC_ADC_TRG                    ADC16_CONFIG_TRG0A
#define BOARD_BLDC_ADC_PREEMPT_TRIG_LEN       (1U)
...
/* BLDC TRGM */
#define BOARD_BLDC_TRIGMUX_IN_NUM        HPM_TRGM0_INPUT_SRC_PWM2_TRGO_0  // HPM_TRGM0_INPUT_SRC_PWM2_TRGO_0
...
#define BOARD_BLDC_TRGM_DAC_MATRIX_TO_PWM_DAC0   trgm_dac_matrix_output_to_pwm2_dac0
#define BOARD_BLDC_TRGM_DAC_MATRIX_TO_PWM_DAC1   trgm_dac_matrix_output_to_pwm2_dac1
#define BOARD_BLDC_TRGM_DAC_MATRIX_TO_PWM_DAC2   trgm_dac_matrix_output_to_pwm2_dac2
...
#define BOARD_BLDC_TMR_RELOAD    (50000) // (100000U)
...
void board_init_led_pins_core0(void);
void board_led_write(uint8_t state);
void board_led_toggle(void);
void board_led_toggle_core0(void);
